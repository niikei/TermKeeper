...
from termkeeper.application.use_cases import ConfigUseCases, InboxUseCases, MeaningUseCases
from termkeeper.infrastructure.schema import init_db


class TermKeeperService(InboxUseCases, MeaningUseCases, ConfigUseCases):
