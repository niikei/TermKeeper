"""Explicit occurrence classification and state-transition use cases."""
...
from termkeeper.domain import CaptureResult, Meaning, OccurrenceItem, OccurrenceStatus
...
class ClassificationUseCases:
    """Inspect and explicitly classify captured occurrences."""
